...
class VideoBase(BaseModel):
    ...
    branch_id: Optional[str] = Field(None, description="分公司ID")
    project: Optional[str] = Field(None, description="所属项目")
    project_id: Optional[str] = Field(None, description="项目ID")
    grid: Optional[str] = Field(None, description="所属网格")
    grid_id: Optional[str] = Field(None, description="grid id")
    team: Optional[str] = Field(None, description="所属工队")
    team_id: Optional[str] = Field(None, description="team id")
    device_type: Optional[str] = Field(None, description="device type")
    holder: Optional[str] = Field(None, description="holder")
    holder_id: Optional[str] = Field(None, description="holder id")
    holder_name: Optional[str] = Field(None, description="holder name")
...
class CameraCreateRequest(BaseModel):
    ...
    channel_no: Optional[int] = Field(1, description="萤石通道号")
    company: Optional[str] = Field(None, description="所属分公司")
    branch_id: Optional[str] = Field(None, description="分公司ID")
    project: Optional[str] = Field(None, description="所属项目")
    project_id: Optional[str] = Field(None, description="项目ID")
    grid: Optional[str] = Field(None, description="所属网格")
    grid_id: Optional[str] = Field(None, description="网格ID")
    team: Optional[str] = Field(None, description="所属工队")
    team_id: Optional[str] = Field(None, description="工队ID")
