...
class FaceService:
    ...
    def _load_face_database(self):
        ...
        try:
            collection = get_mongo_collection("sql_personnel")
        ...
        count = 0
        print("⚙️ [人脸服务] 正在?MongoDB personnel 录入人脸特征...")
        ...
        for person in people:
            ...
            if not img_path or not os.path.exists(img_path):
                print(f"   ?[录入跳过] {name} 图片不存? {img_path}")
                continue
