...
MODEL_REGISTRY: Dict[str, ModelConfig] = {
    ...
    "smoking": ModelConfig(
        ...
        label_alias_map={"Smoking": "smoking"},
        confidence=0.5,
    ),
    "fire": ModelConfig(
        algorithm_code="fire",
    ...
    "face": ModelConfig(
        ...
        enabled=False,
        disabled_reason="model_label_not_face",
    ),
    "phone": ModelConfig(
        ...
        allowed_labels=frozenset({"phone", "call", "calling"}),
        label_alias_map={"call": "phone", "calling": "phone"},
    ),
}
