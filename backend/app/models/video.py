...
class VideoDevice(Base):
    ...
    project = Column(String(100), nullable=True, comment="所属项目")
    grid = Column(String(100), nullable=True, comment="所属网格")
    team = Column(String(100), nullable=True, comment="所属工队")
